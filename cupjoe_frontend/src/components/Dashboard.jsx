...
import styles from "./Dashboard.module.css"; // Make sure to import your CSS file
      ...
      <main>
        ...
        {categoryModalVisible && (
          <div className={styles.category_modal}>
            <div className={styles.category_form}>
              ...
              {editCategoryId !== null && (
                <div className={styles.edit_category_form}>
                  <label htmlFor="categoryName">Category Name:</label>
                  <input
                    type="text"
                    id="categoryName"
          ...
          <div className={styles.bill_modal}>
            ...
            <div className={styles.bill_search}>
              <input
                ...
                onChange={(e) => setSearchQuery(e.target.value)}
              />
              <button className={styles.searchbill} onClick={handleSearchBill}>
                Search
              </button>
            </div>
            ...
            {/* Close button */}
            <button className={styles.closebill} onClick={closeBillModal}>
              Close
            </button>
          </div>
        )}
        ...
        {manageUsersVisible && (
          <div className={styles.manage_users_container}>
            ...
            <button className={styles.user1} onClick={closeManageUsers}>
              Close
            </button>
            {/* Edit user form */}
            {editUserId !== null && (
              <div className={styles.edit_user_form}>
