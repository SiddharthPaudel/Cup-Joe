...
const Dashboard = () => {
  ...
  const handleSearchBill = () => {
    ...
    const filteredBills = billList.filter((bill) => {
      ...
      const paymentMethodMatch = bill.paymentMethod
        .toLowerCase()
        .includes(query);
    ...
    <div>
      ...
      {profilePopUpVisible && (
        <div className="profile-popup">
          ...
          <button className="button2 icon-button" onClick={handleLogout}>
            Logout
          </button>
        </div>
      )}
      ...
      <main>
          ...
          <div className="category-modal">
            <div className="category-form">
              ...
              <div className="search-category">
                ...
                />
                <button onClick={handleSearchCategory} className="barsearch">
                  Search
                </button>
                <button
                  className="add-category"
                  onClick={() =>
                    setAddCategoryFormVisible(!addCategoryFormVisible)
                  }
                >
                  Add Category
                </button>
              ...
              {addCategoryFormVisible && (
                <div className="add-category-form">
                  ...
                  <button onClick={() => setAddCategoryFormVisible(false)}>
                    Close
                  </button>
                </div>
              )}
              ...
              <button className="close-category" onClick={closeCategoryModal}>
                Close
              </button>
              {editCategoryId !== null && (
          ...
          <div className="bill-modal">
            ...
            <div className="bill-search">
              <input
                ...
                onChange={(e) => setSearchQuery(e.target.value)}
              />
              <button className="Searchill" onClick={handleSearchBill}>
                Search
              </button>
            </div>
            ...
            {editBillId !== null && (
              <div className="edit-bill-form">
                ...
                <input
                  type="text"
                  value={editBillEmail}
                  onChange={(e) => setEditBillEmail(e.target.value)}
                />
                <label>Contact Number:</label>
                <input
                  type="text"
                  value={editBillContactNumber}
                  onChange={(e) => setEditBillContactNumber(e.target.value)}
                />
            ...
            {/* Close button */}
            <button className="closebill" onClick={closeBillModal}>
              Close
            </button>
          </div>
        )}
        ...
        {manageUsersVisible && (
          <div className="manage-users-container">
              ...
              <tbody>
                {userList.map((user) => (
                  <tr key={user.id}>
                    ...
                    <td>
                      <button className="user" onClick={() => editUser(user)}>
                        Edit
                      </button>
            ...
            <button className="user1" onClick={closeManageUsers}>
              Close
            </button>
            {/* Edit user form */}
            {editUserId !== null && (
          ...
          <div className="order-form-container">
            <div className="customer-details-form">
              ...
              <input
                ...
                onChange={(e) =>
                  handleCustomerDetailsChange("contactNumber", e.target.value)
                }
              />
              <label>Payment Method:</label>
              <select
                ...
                onChange={(e) =>
                  handleCustomerDetailsChange("paymentMethod", e.target.value)
                }
              >
                <option value="cash">Cash</option>
                <option value="card">Card</option>
            ...
            <div className="product-details-form">
              ...
              <label for="total" class="move-right">
                Total Amount:
              </label>
              <input
                type="text"
